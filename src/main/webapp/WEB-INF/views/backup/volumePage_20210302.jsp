...
<header>
	<div id="header_wrap">
		<div id="header_top">
			<h1>뭐 사징?</h1>
			<div class="userInfo signout">
				<span><a href="javascript:void(0)" onclick="javascript:onMovePageP('loginPage');">로그인</a></span>
				<span><a href="javascript:void(0)" onclick="javascript:onMovePageP('signupPage');">회원가입</a></span>
			</div>
<!-- 			<div class="userInfo signin"> -->
<!-- 				<span>홍길동(hong@hong.net)</span> -->
<!-- 			</div>		 -->
		</div>
		<div id="searchOption">
			<form id="frm" name="frm">
				...
				<div class="row">
					...
					<input type="checkbox" id="favorite" name="favorite" <c:if test="${searchOptionVO.favorite eq 'on'}">checked</c:if>/><label for="favorite" class="checkboxLabel">즐겨 찾기</label>
				</div>
				<div class="row">
