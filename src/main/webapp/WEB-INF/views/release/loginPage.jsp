...
<body>
	<div class="sign_wrap">
		...
		<ul class="sign_form">
			...
			<li class="sign_etc">
				<a href="javascript:void(0)" onclick="javascript:onMovePageP('signupPage');">회원가입</a>&nbsp;|
				<a href="javascript:void(0)" onclick="javascript:onMovePageP('signupPage');">아이디 찾기</a>&nbsp;|
				<a href="javascript:void(0)" onclick="javascript:onMovePageP('signupPage');">비밀번호 찾기</a>
			</li>
			<li>
				<div class="horizontal_line"></div>
			</li>
			<li class="social_btn">
				<button type="button" class="in_Btn1 kko" onclick="javascript:onsignupBtn()">카카오 로그인</button>
				<button type="button" class="in_Btn1 ggl" onclick="javascript:onsignupBtn()">구글 로그인</button>
				<button type="button" class="in_Btn1 nav" onclick="javascript:onsignupBtn()">네이버 로그인</button>
				<button type="button" class="in_Btn1 fab" onclick="javascript:onsignupBtn()">페이스북 로그인</button>
			</li>
			<li>
				<div class="horizontal_line"></div>
			</li>
